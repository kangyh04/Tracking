...
{
	struct AStarAlgorithm_eventCalculateManhattanDistance_Parms
	{
		FIntPoint pos1;
		FIntPoint pos2;
		int32 ReturnValue;
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAStarAlgorithm_CalculateManhattanDistance_Statics::NewProp_pos1 = { "pos1", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AStarAlgorithm_eventCalculateManhattanDistance_Parms, pos1), Z_Construct_UScriptStruct_FIntPoint, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAStarAlgorithm_CalculateManhattanDistance_Statics::NewProp_pos2 = { "pos2", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AStarAlgorithm_eventCalculateManhattanDistance_Parms, pos2), Z_Construct_UScriptStruct_FIntPoint, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UAStarAlgorithm_CalculateManhattanDistance_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AStarAlgorithm_eventCalculateManhattanDistance_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAStarAlgorithm_CalculateManhattanDistance_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAStarAlgorithm_CalculateManhattanDistance_Statics::NewProp_pos1,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAStarAlgorithm_CalculateManhattanDistance_Statics::NewProp_pos2,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAStarAlgorithm_CalculateManhattanDistance_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UAStarAlgorithm_CalculateManhattanDistance_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAStarAlgorithm_CalculateManhattanDistance_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UAStarAlgorithm, nullptr, "CalculateManhattanDistance", Z_Construct_UFunction_UAStarAlgorithm_CalculateManhattanDistance_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAStarAlgorithm_CalculateManhattanDistance_Statics::PropPointers), sizeof(Z_Construct_UFunction_UAStarAlgorithm_CalculateManhattanDistance_Statics::AStarAlgorithm_eventCalculateManhattanDistance_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04822401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAStarAlgorithm_CalculateManhattanDistance_Statics::Function_MetaDataParams), Z_Construct_UFunction_UAStarAlgorithm_CalculateManhattanDistance_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Z_Construct_UFunction_UAStarAlgorithm_CalculateManhattanDistance_Statics::AStarAlgorithm_eventCalculateManhattanDistance_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UAStarAlgorithm_CalculateManhattanDistance()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UAStarAlgorithm_CalculateManhattanDistance_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UAStarAlgorithm::execCalculateManhattanDistance)
{
	P_GET_STRUCT(FIntPoint,Z_Param_pos1);
	P_GET_STRUCT(FIntPoint,Z_Param_pos2);
	P_FINISH;
	P_NATIVE_BEGIN;
	*(int32*)Z_Param__Result=UAStarAlgorithm::CalculateManhattanDistance(Z_Param_pos1,Z_Param_pos2);
	P_NATIVE_END;
}
...
struct Z_Construct_UFunction_UAStarAlgorithm_FindPath_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		...
		{ "Comment", "// static TArray<int> FindPath(const TArray<int> grid, int width, int startX, int startY, int destX, int destY);\n" },
#endif
		{ "ModuleRelativePath", "Public/AStarAlgorithm.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "static TArray<int> FindPath(const TArray<int> grid, int width, int startX, int startY, int destX, int destY);" },
#endif
	};
	...
	static const UECodeGen_Private::FStructPropertyParams NewProp_destPos;
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAStarAlgorithm_FindPath_Statics::NewProp_startPos = { "startPos", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AStarAlgorithm_eventFindPath_Parms, startPos), Z_Construct_UScriptStruct_FIntPoint, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAStarAlgorithm_FindPath_Statics::NewProp_destPos = { "destPos", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AStarAlgorithm_eventFindPath_Parms, destPos), Z_Construct_UScriptStruct_FIntPoint, METADATA_PARAMS(0, nullptr) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAStarAlgorithm_FindPath_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAStarAlgorithm_FindPath_Statics::NewProp_startPos,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAStarAlgorithm_FindPath_Statics::NewProp_destPos,
...
DEFINE_FUNCTION(UAStarAlgorithm::execFindPath)
{
	...
	P_GET_STRUCT(FIntPoint,Z_Param_destPos);
	P_FINISH;
	P_NATIVE_BEGIN;
	*(TArray<int32>*)Z_Param__Result=UAStarAlgorithm::FindPath(Z_Param_grid,Z_Param_width,Z_Param_startPos,Z_Param_destPos);
	P_NATIVE_END;
}
